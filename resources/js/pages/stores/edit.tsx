...
export default function StoresEdit({ store }: Props) {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        router.patch(`/stores/${store.id}`, formData, {
        ...
        <>
            ...
            <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 p-4 sm:p-6 lg:p-8">
                <div className="mx-auto max-w-2xl">
                    ...
                    {/* Form Card */}
                    <form onSubmit={handleSubmit} className="rounded-lg border border-slate-200 bg-white p-8 shadow-sm space-y-6">
                        {/* Store Number */}
                        <div>
